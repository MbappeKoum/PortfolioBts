...
function ajouterUtilisateur($id, $nom, $mdp,$cat,&$tabErr)
{
  // Ouvrir une connexion au serveur mysql en s'identifiant
  $connexion = connecterServeurBD();
...
function AjouterMateriel($unType, $unPrix, $uneTaille, $uneCouleur, $unModel, $unPoids, &$tabErr)
{
  // Ouvrir une connexion au serveur mysql en s'identifiant
  $connexion = connecterServeurBD();
  ...
  ."(type,prix,taille,couleur,model,poids) values ('"
  .$unType."','"
  .$unPrix."','"
  .$uneTaille."','"
  .$uneCouleur."','"
